    ...
    <div className="StatusPage">
      ...
      {currentStatus === "A" &&(
        <div className="success">
          <span>Congratulations! It got approved.</span>
          <span>You can enter into premises</span>
        </div>
      )}
      {currentStatus === "P" &&(
        <div className="Pending">
          <span>No decision taken yet! It’s pending.</span>
      ...
      {currentStatus === "R" &&(
        <div className="Reject">
          <span>Sorry! It got rejected.</span>
        ...
        {!currentStatus === "A" &&(
          ...
          <Button text="Go back to home page" height={"44px"} width={"100%"} />
        </div>
        )}
